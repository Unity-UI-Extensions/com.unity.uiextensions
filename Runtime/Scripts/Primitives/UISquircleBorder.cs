...
{
    [AddComponentMenu("UI/Extensions/Primitives/UISquircleBorder")]
...
#if UNITY_EDITOR
        [CustomEditor(typeof(UISquircleBorder))]
        public class UISquircleBorderEditor : Editor
        {
            public override void OnInspectorGUI()
            {
                DrawDefaultInspector();
                UISquircleBorder script = (UISquircleBorder)target;
                GUILayout.Space(10f);
